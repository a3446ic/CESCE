...
-- v14: Comprobar los recibos nuevos que nos les cuadra Cabecera vs Suma Detalle y ACTUALIZAR EL ESTADO a ‘WARNING’
	...
	WHERE 
		...
		CALL EXT.LIB_GLOBAL_CESCE:w_debug (i_Tenant, 'ACTUALIZADOS ' || To_VARCHAR(::ROWCOUNT) || ' REGISTROS EN EXT.RECIBOS_FACTURAS CON ESTADO WARNING'  , cReportTable, io_contador);
