CREATE PROCEDURE "EXT"."SP_RETORNO_CONTABILIDAD" (OUT FILENAME VARCHAR(120), IN pPlRunSeq BIGINT) LANGUAGE SQLSCRIPT SQL SECURITY DEFINER DEFAULT SCHEMA "EXT" AS
BEGIN
